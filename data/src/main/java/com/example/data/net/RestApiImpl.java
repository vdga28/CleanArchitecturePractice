...
public class RestApiImpl implements RestApi {
  ...
  private final PostEntityJsonMapper userEntityJsonMapper;

  /**
   * Constructor of the class
   *
   * @param context {@link android.content.Context}.
   * @param userEntityJsonMapper {@link PostEntityJsonMapper}.
   */
  public RestApiImpl(Context context, PostEntityJsonMapper userEntityJsonMapper) {
  ...
  @Override
  public Observable<PostsEntity> userEntityById(final int userId) {
    return Observable.create(emitter -> {
      if (isThereInternetConnection()) {
        try {
