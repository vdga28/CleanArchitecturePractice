...
public class UserCacheImpl implements UserCache {
  ...
  @Override
  public Observable<PostsEntity> get(final int userId) {
    return Observable.create(emitter -> {
      ...
      final PostsEntity userEntity =
          UserCacheImpl.this.serializer.deserialize(fileContent, PostsEntity.class);
  ...
  @Override
  public void put(PostsEntity userEntity) {
    if (userEntity != null) {
      final File userEntityFile = this.buildFile(userEntity.getUserId());
      if (!isCached(userEntity.getUserId())) {
        final String jsonString = this.serializer.serialize(userEntity, PostsEntity.class);
